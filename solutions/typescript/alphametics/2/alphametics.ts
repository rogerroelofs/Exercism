// alpamatics is replacing letters with numbers to solve a puzzle
// input example = I + BB == ILL
// output example = { I: 1, B: 9, L: 0 }
// figure out how to assign numbers to letters to solve the puzzle
